...
public class PlayerShooting : MonoBehaviour
{
    ...
    {
        RaycastHit result;
        if (Physics.Raycast(guns.centralGun.transform.position, guns.centralGun.transform.forward, out result, 100.0f))
        {
    ...
    {
        Instantiate(lazer, pos, transform.rotation * Quaternion.Euler(rot));
    }
}
